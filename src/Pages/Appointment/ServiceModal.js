        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <h3 className="font-bold text-lg text-secondary">Booking on: {name}</h3>
                    <form onSubmit={handleBooking} className="grid grid-cols-1 gap-4 justify-content-center">
                        <input type="text" value={format(date, 'PP')} disabled className="input input-bordered " />
                        ...
                        <input type="submit" value="submit" className="input btn btn-secondary input-bordered" />
                    </form>
                </div>
            </div>
        </div>
